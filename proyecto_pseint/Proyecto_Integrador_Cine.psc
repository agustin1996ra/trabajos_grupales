...
SubProceso cartillapeliculas(peliculas Por Referencia)
	...
	Segun num4 Hacer
		1:
			p1<-"Opción 1: SONIC 2 LA PELÍCULA";
			peliculas<-p1;
		2:
			p2<-"Opción 2: RÁPIDOS Y FURIOSOS 9";
			peliculas<-p2;
		3:
			p3<-"Opción 3: MORBIUS";
			peliculas<-p3;
		De Otro Modo:
			Escribir "Opción Incorrecta.Por favor, digite nuevamente:";
	FinSegun
...
Proceso CINE
	...
	Repetir
		...
		Escribir "SELECCIONE QUE OPERACIÓN DESEA REALIZAR:";
		Escribir "";
		...
		Segun opcion Hacer
			1:
				...
				Limpiar Pantalla;
				Escribir "";
				Escribir "Por favor, seleccione la posición de la butaca:";
				Escribir "";
