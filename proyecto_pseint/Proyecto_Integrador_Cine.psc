...
subProceso tarifa(precio Por Referencia,entradamayores,entradamenores,cantidadentradas)
	...
	Mientras (i<cantidadentradas) Hacer
		...
		Leer Edades;
			// verificacion de que no sea menor a 5 a�os de edad en caso de que haya un ni�o menor de edad se le mostrara un mensaje 
...
SubAlgoritmo Mensaje
	...
	Escribir '                                      ---------------------------------------------------------------------------------------------------------                      ';
	Escribir "                                        �El cine es un bien cultural, un medio de expresi�n art�stica, un hecho de comunicaci�n social,                              ";
	Escribir "                                                   una industria, un objeto de comercio, ense�anza, estudio e investigaci�n.!                                        ";
	Escribir '                                                 ---------------------------------------------------------------------------------                                   ';
	Escribir "";
